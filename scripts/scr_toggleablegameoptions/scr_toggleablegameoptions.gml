...
global.anglerotation = false //Angle rotation is refering to Slope rotation.So when the player is on a slope, the players sprite will get rotated diagnoally. Set this to True to enable it, and set it to False to disable this all together.
global.smoothcamera = false //Smooth camera enables the camera to be alot smoother then the previous camera thats in the base game. Set this to False if you want to use the original camera.
global.slopemomentum = true //Slope momentum refers to the momentum you gain from going down a slope aswell as going up one.If set to True, The slope momentum will be alot faster and not as slow as the original slope momentum.Set this to false if you want the original momentum.
